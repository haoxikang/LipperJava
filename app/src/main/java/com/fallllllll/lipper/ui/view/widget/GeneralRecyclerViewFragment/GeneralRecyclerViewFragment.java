package com.fallllllll.lipper.ui.view.widget.GeneralRecyclerViewFragment;
...
public class GeneralRecyclerViewFragment extends Fragment implements GeneralContract.View {
    ...
    private void initListeners() {
        ...
        mSwipeRefreshLayout.setOnRefreshListener(() -> mGeneralPresenter.checkAndRefreshData());
    }
